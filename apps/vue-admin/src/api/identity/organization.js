...
// ----------------
// 列表
export function ticketAgentList() {
  return request({
...
export function ticketAgentDetail(agentId) {
  return request({
      url: `/api/abp/partner/ticket-agent/${agentId}`,
      method: 'get'
  })
}

// 获取账户信息
export function getAgentByUser(userId) {
  return request({
    url: `/api/abp/partner/ticket-agent/by-user/${userId}`,
    method: 'get'
  })
}
