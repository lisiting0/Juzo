      ...
      <div class="custom-card">
        ...
        <div class="card-box">
          <el-row>
            <template v-if="ways === '黑屏信息提取'">
              <el-col :span="4">
                <el-form-item prop="bigPnr" label="大PNR">
                  <el-input v-model.trim="dto.bigPnr" clearable />
                </el-form-item>
              </el-col>
              <el-col :span="4">
                <el-form-item prop="smallPnr" label="小PNR">
                  <el-input v-model.trim="dto.smallPnr" clearable />
                </el-form-item>
              </el-col>
            </template>
            <el-col :span="4">
            ...
            <el-col :span="4">
              <el-form-item prop="supplierOrganizationId" label="供应商">
                九州自营
              </el-form-item>
            </el-col>
            <el-col :span="4">
          ...
          <el-table :data="dto.orderFlightBOList" border style="width: 100%">
            ...
            >
              <template slot-scope="scope">
                <el-button
                  v-if="dto.orderFlightType === 2 && dto.orderFlightBOList.length > 3"
                  size="mini"
                  type="danger"
            ...
            <el-table-column width="100" label="航程类型" prop="segmentType">
              <template slot-scope="scope">
                <el-form-item
                  label=""
            ...
            <el-table-column width="150" label="起飞机场" prop="departureAirportInfo">
              <template slot-scope="scope">
                <el-form-item
                  label=""
            ...
            <el-table-column width="150" label="到达机场" prop="arrivalAirportInfo">
              <template slot-scope="scope">
                <el-form-item
                  label=""
            ...
            <el-table-column width="120" label="航司" prop="carrierNumber">
              <template slot-scope="scope">
                <el-form-item
                  label=""
            ...
            <el-table-column width="120" label="航班号" prop="flightNumber">
              <template slot-scope="scope">
                <el-form-item
                  label=""
            ...
            <el-table-column width="195" label="起飞时间" prop="depatureDate">
              <template slot-scope="scope">
                <el-form-item
                  label=""
            ...
            <el-table-column width="195" label="到达时间" prop="arrivalTime">
              <template slot-scope="scope">
                <el-form-item
                  label=""
                  :prop="`orderFlightBOList[${scope.$index}].departureTime`"
            ...
            <el-table-column width="120" label="舱位等级">
              <template slot-scope="scope">
                <el-form-item
                  label=""
            ...
            <el-table-column width="100" prop="cabinCode" label="舱位">
              <template slot-scope="scope">
                <el-form-item
                  label=""
            ...
            <el-table-column width="100" prop="childCabinCode" label="儿童舱位">
              <template slot-scope="scope">
                <el-form-item
                  label=""
                  :prop="`orderFlightBOList[${scope.$index}].childCabinCode`"
                  :rules="orderFlightBORules.childCabinCode"
                  class="mb-0"
                >
                  <el-input
                    v-model.trim="scope.row.childCabinCode"
                    clearable
                    placeholder="舱位"
                  />
                </el-form-item>
            ...
            <el-table-column width="100" prop="babyCabinCode" label="婴儿舱位">
              <template slot-scope="scope">
                <el-form-item
                  label=""
                  :prop="`orderFlightBOList[${scope.$index}].babyCabinCode`"
                  :rules="orderFlightBORules.babyCabinCode"
                  class="mb-0"
                >
                  <el-input
                    v-model.trim="scope.row.babyCabinCode"
                    clearable
                    placeholder="舱位"
                  />
                </el-form-item>
      ...
      <div class="custom-card">
        ...
        <div class="card-box" style="padding: 15px 10px">
          <el-table :data="dto.orderPassengerBOList" border style="width: 100%">
            ...
            <el-table-column :width="200" label="证件类型" prop="cardType">
              <template slot-scope="scope">
                <el-form-item
                  label=""
            ...
            <el-table-column :width="250" label="证件号" prop="cardNum">
              <template slot-scope="scope">
                <el-form-item
                  v-if="isIdentityCard"
                  label=""
      ...
      <div class="custom-card">
        ...
        <div class="card-box" style="padding: 15px 10px">
          <el-table :data="insuranceBOList" border style="width: 100%">
            ...
            <el-table-column width="180" label="姓名" prop="passenger">
              <template slot-scope="scope">
            ...
            <el-table-column width="180" label="保险类型" prop="insuranceType">
              <template slot-scope="scope">
            ...
            <el-table-column width="180" label="航意险名称" prop="id">
              <template slot-scope="scope">
                <el-form-item label="" prop="insuranceType" class="mb-0">
                  <el-select
            ...
            <el-table-column width="150" prop="salesPrice" label="销售价格">
              <template slot-scope="scope">
                <el-input
...
export default {
  ...
  methods: {
    ...
    initDto() {
      ...
      this.dto.orderFlightBOList = this.pnrInformation.flights.map(
        (flight, flightIndex) => ({
          ...
          flightNumber: flight.fullFlightNo
            ? flight.fullFlightNo.substring(2, flight.fullFlightNo.length)
            : '',
      ...
      this.dto.orderPassengerBOList = this.pnrInformation.passengers.map(
        (passengerEle) => ({
          ...
          gender: passengerEle.gender ? passengerEle.gender : this.getGenderFromCardNo(passengerEle.cardNo),
          originTicketPrice: 0,
          soldTicketPrice: 0,
          flightTax: 0,
          fuelTax: 0,
    ...
    // 设置出生日期
    resetBirthday(val, index) {
      this.$set(this.dto.orderPassengerBOList[index], 'birthday', val)
    },
    // 设置男女
    resetGenger(val, index) {
      this.$set(this.dto.orderPassengerBOList[index], 'gender', this.getGenderFromCardNo(val))
    },
    // 导入乘客
