  ...
  >
    ...
    >
      <el-form-item label="退票类型">
        <el-select v-model="detailInfo.isVolunteer" clearable>
          <el-option
      ...
      <el-form-item label="退票理由">
        <el-select v-model="detailInfo.refundTicketReason" clearable>
          <el-option
...
<script>
  import { uploadAppendix } from '@/api/agent/refund-order'
  ...
  export default {
    ...
    methods: {
      detail(row) {
        this.detailInfo.refundOrderNo = row
