    ...
    <div class="drawer-container">
        <div>
            <h3 class="drawer-title">
                {{ $t("AdminService['Settings:Title']") }}
            </h3>

            <div class="drawer-item">
                <span>{{ $t("AdminService['Settings:Theme']") }}</span>
                <theme-picker
            ...
            <div class="drawer-item">
                <span>{{ $t("AdminService['Settings:TagsView']") }}</span>
                <el-switch v-model="tagsView" class="drawer-switch" />
            </div>

            <div class="drawer-item">
                <span>{{ $t("AdminService['Settings:FixedHeader']") }}</span>
                <el-switch v-model="fixedHeader" class="drawer-switch" />
            </div>

            <div class="drawer-item">
                <span>{{ $t("AdminService['Settings:SidebarLogo']") }}</span>
