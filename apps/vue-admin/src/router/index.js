...
import flightChangeManagerRouter from './modules/flight-change-manager'
import groupToolRouter from './modules/group-tool'
    ...
    children: [
      {
        ...
        meta: {
          ...
          title: 'AdminService["Menu:Dashboard"]',
          icon: 'dashboard',
    ...
    children: [
      {
        ...
        name: 'Profile',
        meta: { title: 'AdminService["Menu:Profile"]', icon: 'user', noCache: true }
      }
    ]
  }
]
