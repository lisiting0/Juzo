...
import { changeOrderDetail, changePreFeesAmountQuery, applyCreateChangeOrder, applyTwoCreateChangeOrder } from '@/api/domestic-tickets/change-order'
...
export default {
  ...
  mounted() {
    ...
    this.$refs.changeFlightDialogRef.rendered = true
